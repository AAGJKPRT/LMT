<%@ Page Title="" Language="C#" MasterPageFile="~/TransPages/SupplierMaster.Master"
    AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="LMT.Supplier.EditProfile" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
                                                        ...
                                                        <table class="table" style="margin: 0px auto;text-align: left;width: 95%;">                                                           
                                                           <tbody>
                                                              <tr>
                                                                 ...
                                                                 <td style="border-top:none"><asp:TextBox ID="txtFullName" runat="server" placeholder="Full Name" CssClass="form-control" meta:resourcekey="txtFullNameResource1"></asp:TextBox>
